...
namespace Interext.OtherCalsses
{
    ...
    {
        private const string lessThanErrorMessage = "Minimum must be less than Maximum.";
        private const string lessThanOrEqualToErrorMessage = "Minimum must be less than or equal to Maximum.";
